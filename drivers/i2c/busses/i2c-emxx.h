...
/* mode */
#define I2C_SMC_NORMAL_SPEED	0	/* nomal mode
					  (maximum transfer rate 97kbit/s) */
#define I2C_SMC_HIGH_SPEED	1	/* high-speed mode(maximum transfer
					  (maximum transfer rate 383kbit/s) */
...
/* IIC_SCLK
 * Standard speed : 4.19MHz-8.38MHz
 * Fast speed     : 4.19MHz-9.2MHz
 */
...
#if CONFIG_I2C_EMXX_SMC1 == 1
#define I2C_DIVIIC_VAL2 (SMU_DIV(25) << 16)
#else
#define I2C_DIVIIC_VAL2 (SMU_DIV(28) << 16)
#endif
#endif
