...
#define INPUT_VOL_MAX				0x1f
#define OUTPUT_VOL_MAX				0x1f
#define VOL_L_GAIN_MASK				(0x1f<<8)		//Gain Left channel Mask
#define VOL_R_GAIN_MASK				(0x1f<<0)		//Gain Right channel Mask
#define VOL_L_GAIN(gain)			(gain<<8)		//Gain Left channel Mask
#define VOL_R_GAIN(gain)			(gain<<0)		//Gain Right channel Mask

#define VOL_ADC_L_GAIN_MASK			(0x1f<<7)		//ADC Gain Left channel Mask
#define VOL_ADC_R_GAIN_MASK			(0x1f<<0)		//ADC Gain Left channel Mask
#define VOL_ADC_L_GAIN(gain)			(gain<<7)		//ADC Gain Left channel Mask
#define VOL_ADC_R_GAIN(gain)			(gain<<0)		//Gain Right channel Mask

//AUXIN volume control (0x08)
#define M_AUXIN_TO_HP_MIXER			(0x1<<15)		//mute AXUIN to HP mixer
#define M_AUXIN_TO_SPK_MIXER			(0x1<<14)		//mute AUXIN to SPK mixer
#define M_AUXIN_TO_MONO_MIXER			(0x1<<13)		//mute AUXIN to MONO mixer

//LINEIN volume control (0x0A)
#define M_LINEIN_TO_HP_MIXER			(0x1<<15)		//mute LINEIN to HP mixer
#define M_LINEIN_TO_SPK_MIXER			(0x1<<14)		//mute LINEIN to SPK mixer
#define M_LINEIN_TO_MONO_MIXER			(0x1<<13)		//mute LINEIN to MONO mixer
...
//Index address
#define EQ_INPUT_VOL_CONTROL	(0x11)
#define EQ_OUTPUT_VOL_CONTROL	(0x12)

//Index data
//EQ Input volume control data
#define EQ_INPUT_VOL_0DB	(0x0)
#define EQ_INPUT_VOL_MINUS_6DB	(0x1)
#define EQ_INPUT_VOL_MINUS_12DB	(0x2)
#define EQ_INPUT_VOL_MINUS_18DB	(0x3)
//EQ Output volume control data
#define EQ_OUTPUT_VOL_MINUS_3DB	(0x0)
#define EQ_OUTPUT_VOL_0DB	(0x1)
#define EQ_OUTPUT_VOL_ADD_3DB	(0x2)
#define EQ_OUTPUT_VOL_ADD_6DB	(0x3)
#define EQ_OUTPUT_VOL_ADD_9DB	(0x4)
#define EQ_OUTPUT_VOL_ADD_12DB	(0x5)
#define EQ_OUTPUT_VOL_ADD_15DB	(0x6)
#define EQ_OUTPUT_VOL_ADD_18DB	(0x7)

//AVC Control(0x68)
#define AVC_ENABLE			(0x1<<15)
#define AVC_TARTGET_SEL_MAS	K	(0x1<<14)
#define	AVC_TARTGET_SEL_R 		(0x1<<14)
#define	AVC_TARTGET_SEL_L		(0x0<<14)

//reg0x14 (RT5621_ADC_REC_MIXER)  controls
#define RT_WAVIN_R_MONO_MIXER_MUTE	(0x1<<0)
#define RT_WAVIN_R_SPK_MIXER_MUTE	(0x1<<1)
#define RT_WAVIN_R_HP_MIXER_MUTE	(0x1<<2)
#define RT_WAVIN_R_PHONE_MUTE		(0x1<<3)
#define RT_WAVIN_R_AUXIN_MUTE		(0x1<<3)
#define RT_WAVIN_R_LINE_IN_MUTE		(0x1<<4)
#define RT_WAVIN_R_MIC2_MUTE		(0x1<<5)
#define RT_WAVIN_R_MIC1_MUTE		(0x1<<6)
#define RT_WAVIN_L_MONO_MIXER_MUTE	(0x1<<8)
#define RT_WAVIN_L_SPK_MIXER_MUTE	(0x1<<9)
#define RT_WAVIN_L_HP_MIXER_MUTE	(0x1<<10)
#define RT_WAVIN_L_PHONE_MUTE		(0x1<<11)
#define RT_WAVIN_L_AUXIN_MUTE		(0x1<<11)
#define RT_WAVIN_L_LINE_IN_MUTE		(0x1<<12)
#define RT_WAVIN_L_MIC2_MUTE		(0x1<<13)
#define RT_WAVIN_L_MIC1_MUTE		(0x1<<14)
...
enum 
{
	...
	RT_WAVOUT_HP_R,
	RT_WAVOUT_HP_L,
	RT_WAVOUT_AUX2HPMIXER,
	RT_WAVOUT_AUX2SPKMIXER,
	RT_WAVOUT_AUX2MONOMIXER,
	RT_WAVOUT_DAC2HPMIXER,
	RT_WAVOUT_DAC2SPKMIXER,
	RT_WAVOUT_LINE2HPMIXER,
	RT_WAVOUT_LINE2SPKMIXER,
	RT_WAVOUT_ALL_ON,
	RT_WAVOUT_ALL_OFF,
	...
	RT_WAVIN_AUXOUT_R,
	RT_WAVIN_AUXOUT_L,
	RT_WAVIN_MIC1_2_MONOMIXER,
	RT_WAVIN_MIC2_2_MONOMIXER,
	RT_WAVIN_MONOMIXER_2_ADCMIXER,
	RT_WAVIN_L_MONOMIXER_2_ADCMIXER,
	RT_WAVIN_R_MONOMIXER_2_ADCMIXER,
	RT_WAVIN_AUX2HPMIXER,
	RT_WAVIN_AUX2SPKMIXER,
	RT_WAVIN_LINE2HPMIXER,
	RT_WAVIN_LINE2SPKMIXER,
	RT_WAVIN_ALL_ON,
	RT_WAVIN_ALL_OFF
};
